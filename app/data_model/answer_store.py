...
class Answer(object):
    def __init__(self, group_id=None, block_id=None, answer_id=None, value=None, group_instance=None, answer_instance=0):
        valid = (group_id or answer_id or block_id or value) is not None

        if not valid:
            raise ValueError("Missing one of 'answer_id', 'block_id' or 'value' for Answer")
